...
export const apiEndpoints = {
  ...
  updateUnitConversion: (id, conversionId) => `/api/inventory/product/${id}/unit-conversions/${conversionId}`,
  ...
  printIndent: (indentId) => `/api/inventory/indent/print-indent/${indentId}`,
  liveActivity: (afterSeq = 0, activeMinutes = 15) =>
    `/report/live-activity?afterSeq=${afterSeq}&activeMinutes=${activeMinutes}`,
  ...
  updatePOLineBilling: (poId, lineId) => `/api/inventory/purchase-order/${poId}/line/${lineId}/billing`,
  ...
  completeServiceOrderLine: (id, lineId) => `/api/inventory/service-order/${id}/line/${lineId}/complete`,
  cancelServiceOrderLine: (id, lineId) => `/api/inventory/service-order/${id}/line/${lineId}/cancel`,
  reopenServiceOrderLine: (id, lineId) => `/api/inventory/service-order/${id}/line/${lineId}/reopen`,
  ...
  poSpendSummary: "/api/inventory/po-spend/summary",
  poSpendByProject: "/api/inventory/po-spend/by-project",
  poSpendBySupplier: "/api/inventory/po-spend/by-supplier",
  poSpendByFirm: "/api/inventory/po-spend/by-firm",
  poSpendTrend: "/api/inventory/po-spend/trend",
  poSpendList: "/api/inventory/po-spend/list?size=50",
  poSpendListHighValue: "/api/inventory/po-spend/list?size=50&highValueOnly=true",
  poSpendExport: "/api/inventory/po-spend/export/excel",
  poSpendExportHighValue: "/api/inventory/po-spend/export/excel?highValueOnly=true",
  poSpendProjects: "/api/inventory/po-spend/projects",
  poSpendSuppliers: "/api/inventory/po-spend/suppliers",
  poSpendFirms: "/api/inventory/po-spend/firms",
